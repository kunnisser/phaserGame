...
class Sugar extends Phaser.Sprite{
    constructor(game, jiongdog) {
        super(game, 0, 0, 'interface', 'sugar.png');
        ...
        this._velocityX = this.game.rnd.integerInRange(3 * this.direct, 5 * this.direct);
        this.deactivate();
        this.addScoreTag();
        this.candyBindClick();
    };
    ...
    deactivate() {
        ...
        this.visible = !1;
        this.scale.set(1.2);
        this._velocityY = this.game.rnd.integerInRange(-400 / 16.67, -320 / 16.67);
    };
